...
VALUES
    (
        ...
        '{"Breakfast", "Snack"}',
        'https://rakskitchen.net/wp-content/uploads/2022/04/avocado-grilled-cheese.jpg',
        'https://www.youtube.com/watch?v=Bxs7U_HaVFE',
        '1. Cut the avocado, remove the seed, scoop the pulp and chop it roughly.    2. In a food processor add avocados, coriander leaves, green chili, lime juice, and salt, and blend smoothly.    3. Take bread slices, place the sliced cheese, and spread the avocado mixture.    4. Cover it with another sliced cheese and bread. Heat a pan and grease it with butter.    5. Place the sandwich on the pan and cook it on low to medium flame.    6. Once it becomes golden brown, flip and repeat the same.    7. Remove it from the pan, cut it gently and serve hot.',
        10,
        2,
...
VALUES
    (
        ...
        '{"Snack", "Dinner"}',
        'https://rakskitchen.net/wp-content/uploads/2022/04/mulligatawny-soup.jpg',
        'https://www.youtube.com/watch?v=oVXA5yJ-2Zw',
        '1. Heat butter and add Indian bay leaves, crushed coriander, garlic, ginger, onion, and potato.     2. Instant pot mode : Saute. Cancel saute and add all spice powders.      3. After that add masoor dal and coriander leaves. Give it a mix. Add 1 & ½ cups of water.      4. Close the lid and pressure cook for 5 minutes at high pressure.      5. Add 1 & ½ cup water furthermore to dilute plus the required salt. Blend smoothly using an immersion blender.      6. Once done, again give it a boil and add coconut milk. Mix well.      7. Turn off the heat. Adjust salt. Add lemon juice and mix well. Serve hot.',
        10,
        4,
...
VALUES
    (
        ...
        '{"Breakfast", "Snack", "Dinner"}',
        'https://hebbarskitchen.com/wp-content/uploads/2021/12/oats-omelette-recipe-how-to-make-eggless-oats-veg-omelette-1-scaled.jpeg.webp',
        'https://www.youtube.com/watch?v=QkkTH5U88Nk',
        '1. In a mixie, take 1 cup of oats and finely powder it, transfer the oats to a large bowl.      2. Add ¼ cup besan, 1 tsp cumin and 1 / 4th tsp turmeric, ½ tomato, ½ carrot, ½ onion, ½ capsicum, ¼ cup curd and ½ tsp salt, and ½ cup water. Mix well.      3. Rest the batter for 5 minutes, or until the oats and rava are soaked well.      4. Now add water as required and form a smooth batter.      5. Just before making an omelette, add ½ tsp eno fruit salt and mix gently.      6. Immediately, heat 2 tsp oil in a pan and pour the prepared batter, cover and cook for 2 minutes.      7. Once the base is cooked well, flip over and cook both sides.      8. Slit in the centre and add oil, for roasting ½ tsp butter, few coriander for extra flavour.Serve hot.',
        5,
        4,
...
VALUES
    (
        ...
        '{"Snack", "Dinner"}',
        'https://rakskitchen.net/wp-content/uploads/2016/10/Chana-masala-pasta-recipe-320x321.jpg',
        'https://www.youtube.com/watch?v=NuWHWUzZDuI',
        '1. Cook pasta and chickpeas. Heat a pan with oil, and temper with cumin seeds. Add garlic, finely chopped onion, green chilies, and fry till transparent.      2. Add pasta sauce/tomato puree. Fry for a minute. Add red chili and chana masala powders, required salt, and kasoori methi, crushed well.      3. Fry for 2 mins. Add cooked chana, 2 tablespoons of the reserved chana cooked water, or according to your consistency preference.      4. Let it cook for 2 minutes. Add cooked pasta and mix well.      5. Add more oil if needed. Toss well until the sauce coats the pasta shiningly, and garnish with coriander leaves.',
        10,
        4,
...
VALUES
    (
        ...
        '{"Snack"}',
        'https://rakskitchen.net/wp-content/uploads/2018/09/potato-masala-chips-recipe.jpg',
        'https://www.youtube.com/watch?v=h8cOtMpS9PU',
        '1. Peel the skin of the potato and keep immersed in water. Use a grater with large holes and grate the potatoes.     2. Grate the potatoes by starting from one end and finishing at another end so that you get a longer grated potato, otherwise will fall short.     3. Keep the grated potato immersed in water and wash well. Drain completely without water in the potato.     4. Take grated potato in a mixing bowl. Add gram flour, rice flour, sesame seeds, red chili powder, turmeric, asafoetida, salt. Deep fry in oil and serve hot.',
        5,
        4,
        'The juice of lemon should be always thin and watery.',
        2,

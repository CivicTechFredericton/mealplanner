...
-- Restores the original behaviour, where any valid Cognito login that does
-- not match an existing record creates a new person.
...
comment on function app.upsert_person_from_cognito(text, text, text) is null;

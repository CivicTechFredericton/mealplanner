...
INSERT INTO app.nutrition(serving_size, serving_size_unit, serving_size_text, calories, total_fat, total_fat_unit, saturated_fat, saturated_fat_unit, trans_fat, trans_fat_unit, cholesterol, cholesterol_unit, sodium, sodium_unit, potassium, carbohydrate, carbohydrate_unit, dietary_fiber, dietary_fiber_unit, total_sugar, total_sugar_unit, protein, protein_unit, vit_a, vit_c, calcium, iron, nutritionable_id, nutritionable_type)
  VALUES (4, 1, 'tbsp', 148, 6.4, 'g', 4.7, 'g', 0, 'g', 0, 'mg', 196.1, 'mg', 0, 16.4, 'g', 4.8, 'g', 2.7, 'g', 6.2, 'g', 2.5, 0, 1.6, 8.2, app_private.meal_id_by_code('cc_side'), 'meal');
INSERT INTO app.nutrition(serving_size, serving_size_unit, serving_size_text, calories, total_fat, total_fat_unit, saturated_fat, saturated_fat_unit, trans_fat, trans_fat_unit, cholesterol, cholesterol_unit, sodium, sodium_unit, potassium, carbohydrate, carbohydrate_unit, dietary_fiber, dietary_fiber_unit, total_sugar, total_sugar_unit, protein, protein_unit, vit_a, vit_c, calcium, iron, nutritionable_id, nutritionable_type)
  VALUES (2, 1, 'tbsp', 55, 5, 'g', 4.5, 'g', 0, 'g', 0, 'mg', 2.5, 'mg', 0, 2.5, 'g', 1.5, 'g', 1, 'g', 0.5, 'g', 0, 0, 0, 3, app_private.product_id_by_upc('80914514137'), 'product');
SELECT
...
INSERT INTO app.meal_plan(person_id, name_en, description_en, tags)
